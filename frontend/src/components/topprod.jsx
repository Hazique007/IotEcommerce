...
const ProductsSection = () => {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        const ids = [1,2,3]; // Arduino, ESP32, Raspberry Pi
  ...
  return (
    <section
      ...
      ref={containerRef}
    >
      <Link to={'/product-details'} className="no-underline">
          ...
          <div className="relative h-full w-full flex justify-center items-center px-4 py-16">
            ...
            >
              ...
              <motion.img
                ...
                className="relative z-20 w-[400px] h-[400px] object-contain -ml-45"
              />
              ...
              <motion.div
                ...
                transition={{ duration: 0.8 }}
              >
                <h2 className="text-3xl font-bold mb-4 font-poppins text-[#c20001]">{productData[0].name}</h2>
